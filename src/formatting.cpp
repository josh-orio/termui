...
Style::Style(std::string foreground, std::string background,
             std::string weight) {
  fg = foreground;
  bg = background;
  w = weight;
...
std::string Style::render(std::string s) {
  return std::format("{}{}{}{}{}{}{}", fg, bg, w, s, colors::DEFAULT,
                     background::DEFAULT, formats::NONE);
}
